...
export const CTAButton: React.FC<CTAButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-athena-blue text-white hover:opacity-90 shadow-lg hover:shadow-2xl",
    secondary: "bg-athena-pink text-white hover:opacity-90 shadow-lg hover:shadow-2xl",
